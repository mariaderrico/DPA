...
def test_PointAdaptive_kNN(data_Fig1, output_Fig1_test1):
    ...
    npt.assert_almost_equal(est.densities_,output_Fig1_test1['rho'], decimal=2)
    npt.assert_almost_equal(est.err_densities_,output_Fig1_test1['rho_err'], decimal=2)
    npt.assert_almost_equal(est.dc_,output_Fig1_test1['dc'], decimal=2)
    #npt.assert_almost_equal(est.k_hat_,output_Fig1_test1['k_hat'], decimal=1)
    #assert_array_equal(est.densities_,output_Fig1_test1['rho'])
